...
lint-py:  ## lint python with ruff
	python -m ruff check airforce1
	python -m ruff format --check airforce1
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix airforce1
	python -m ruff format airforce1
...
test:  ## run python tests
	python -m pytest -v airforce1/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v airforce1/tests --cov=airforce1 --cov-report term-missing --cov-report xml
